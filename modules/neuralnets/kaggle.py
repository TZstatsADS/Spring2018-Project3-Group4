    ...
    with tf.Session() as sess:
        ...
        for epc in range(epoch):
            ...
            for itr in range(iters):
                ...
                _, cur_loss, training_eve = sess.run([step, loss, eve], feed_dict={xs: training_batch_x, ys: training_batch_y})
                if iter_total % 10 == 0:
                ...
                if iter_total % 100 == 0:
                    ...
                    if verbose:
                        training_acc = 100 - training_eve * 100 / training_batch_y.shape[0]
                        print('{}/{} loss: {} validation accuracy : {}% training accuracy: {}%'.format(
                            batch_size * (itr + 1),
                            X_train.shape[0],
                            cur_loss,
                            valid_acc,
